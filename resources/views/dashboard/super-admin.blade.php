        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Administración total del sistema.</p>
                </div>

                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Servicios</h3>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Configuración de catálogo y precios.</p>
                </div>

                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Reportes</h3>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Consulta global del negocio.</p>
                </div>
            </div>
