    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <a href="{{ route('workers.index') }}" class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 block hover:scale-105 transition">
                ...
                <a href="{{ route('services.index') }}" class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 block hover:scale-105 transition">
                ...
                <a href="{{ route('payment-methods.index') }}" class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 block hover:scale-105 transition">
                ...
                <a href="{{ route('service-records.index') }}" class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 block hover:scale-105 transition">
